        ...
        <div class="sidebar__wrapper">
            ...
            <div class="modal_background" v-if="SeeTask">
                ...
                <ThirdTask @correct="checkCorrect(3)" :childId="props.childId" :finish="finish" :end="endTime"
                    @close="close()" @next-modal="next(4, '../assets/audio/Task4/45.4.mp3')" v-if="taskId === 3">
                </ThirdTask>
                ...
                <SixTask @correct="checkCorrect(6)" :end="endTime" :childId="props.childId" @close="close()" @next-modal="next(7, '../assets/audio/Task7/261.7_.mp3')" v-if="taskId === 6"></SixTask>
                ...
                <NineTask @correct="checkCorrect(9)" :childId="props.childId" :finish="finish" :end="endTime"
                    @close="close()" @next-modal="next(10, '../assets/audio/Task10/317.10.mp3')" v-if="taskId === 9"></NineTask>
                <TenthTask @correct="checkCorrect(10)" :childId="props.childId" :finish="finish" :end="endTime"
                    @close="close()" @next-modal="next(11, '../assets/audio/Task11/330.11.mp3')" v-if="taskId === 10"></TenthTask>
                <ElevenTask @correct="checkCorrect(11)" :childId="props.childId" :finish="finish" :end="endTime"
                    @close="close()" @next-modal="next(12, '../assets/audio/Task12/349.12.mp3')" v-if="taskId === 11"></ElevenTask>
                <TwelfthTask @correct="checkCorrect(12)" :childId="props.childId" :end="endTime" @close="close()" @next-modal="next(13, '../assets/audio/Task13/370.13.mp3')" v-if="taskId === 12"></TwelfthTask>
                ...
                <FourteenthTask @correct="checkCorrect(14)" :childId="props.childId" :end="endTime" @close="close()" @next-modal="next(15, '../assets/audio/Task15/390.15.mp3')" v-if="taskId === 14">
                </FourteenthTask>
                <FifteenTask @correct="checkCorrect(15)" :childId="props.childId" :end="endTime" @close="close()" @next-modal="next(16, '../assets/audio/Task16/427.16_.mp3')" v-if="taskId === 15"></FifteenTask>
                <SixteenthTask @correct="checkCorrect(16)" :childId="props.childId" :end="endTime" @close="close()" @next-modal="next(17, '../assets/audio/Task17/454.17.mp3')" v-if="taskId === 16">
                </SixteenthTask>
                <SeventeenthTask @correct="checkCorrect(17)" :childId="props.childId" :end="endTime" @close="close()" @next-modal="next(18, '../assets/audio/Task18/471.18.mp3')" v-if="taskId === 17">
                </SeventeenthTask>
