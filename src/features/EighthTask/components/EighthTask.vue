                    ...
                    <div class="draggable-list__right-wrapper">
                        <div class="draggable-list__right-wrapper-cloud">
                            ...
                            <div class="draggable-list__set-syllables">
                                <div class="draggable-list__set-syllables1" v-for="(syllables_row, syllables_row_index) in syllables[2]" :key="syllables_row_index">
                                    <div v-for="syllable in syllables_row" :key="syllable.id">
                                        <q-btn
                                            ...
                                            :draggable="draggable"
                                            @dragstart="drag($event, syllable, 2)" 
                                            @dragover.prevent
                                            @click="clickText(syllable)"
                                            :value="syllable.text">
                                            {{ syllable.text }}
                        ...
                        <div class="draggable-list__right-wrapper-answer">
                            <div class="draggable-list__right-answer">
                                <div class="draggable-list__right-answer-square">
                                    <input @drop="drop($event, 1)" @dragover="allowDrop($event)" class="answer draggable-list__step-button" readonly v-model="squareAnswer.text"/>
                                </div>
                                <div class="draggable-list__right-answer-circle">
                                    <input @drop="drop($event, 2)" @dragover="allowDrop($event)" class="answer draggable-list__syllable" readonly v-model="circleAnswer.text"/> 
                                </div>
                            </div>
                        </div>
                    </div>
