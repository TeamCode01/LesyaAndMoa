...
const dataAnswer = [
    [[{ id: 2, text: 'ВЕ', isActive: false, error: 0 }, { id: 3, text: 'СЁ', isActive: false, error: 0 }, { id: 5, text: 'ЛЫ', isActive: false, error: 0 }, { id: 6, text: 'Е', isActive: false, error: 0 }], [{ id: 7, text: 'РЕ', isActive: false, error: 0 }, { id: 9, text: 'БЯ', isActive: false, error: 0 }, { id: 11, text: 'ТА', isActive: false, error: 0 }]],
    [[{ id: 13, text: 'НА', isActive: false, error: 0 }, { id: 14, text: 'ШИ', isActive: false, error: 0 }], [{ id: 16, text: 'ДРУ', isActive: false, error: 0 }, { id: 18, text: 'ЗЬЯ', isActive: false, error: 0 }]]
];
