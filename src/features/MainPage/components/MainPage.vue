<template>
    ...
    <div @click.prevent="shareLink" class="link-share">
            ...
            <div v-if="show_socials" class="networks__wrapper">
                ...
                >
                    <img
                        ...
                        :src="getImageUrl(network.icon)"
                    />
                </ShareNetwork>
                <div @click="copyLink" class="network__copy">
                    <img
                        class="networks__icon"
                        src="@app/assets/icons/link_copy_icon.svg"
                        alt="copy"
                    />
                </div>
        ...
        <img
            v-if="!show_socials"
            src="@app/assets/backgrounds/share-img.svg"
            alt="share"
        />
    </div>
    ...
    <div class="main">
        <img
            src="@app/assets/backgrounds/main-bg.jpg"
            alt="main-bg"
            class="main__bg"
        />
        <div class="main__wrapper">
            <div class="main__wrapper-text">
                ...
                <p class="text main__text">
                    Увлекательное приключение с интерактивными заданиями для
                    профилактики и коррекции дислексии
                </p>
            </div>
            <router-link
            ...
            <div class="Test__wrapper">
                <div class="Test__wrapper-text">
                    ...
                    <p class="Test__wrapper_text">
                        Мы услышали речь увиденных нами странных героев. Но как
                        нам понять друг друга? Пройди задание и присоединяйся к
                        тем, кто помогает инопланетянам понять нас.
                    </p>
                </div>
                <Button
                    @click="openTest()"
            ...
            <div class="about__wrapper-item">
                <div class="about__wrapper-item-container">
                    <div class="about__wrapper-item-reverse-words">
                        ...
                        >
                            <span
                                class="about__wrapper-item1-top-text-option1_leveling"
                                ><span
                                    class="about__wrapper-item1-top-text-option1_leveling-letter"
                                    >ч</span
                                >и<span
                                    class="about__wrapper-item1-top-text-option1_leveling-letter"
                                    >т</span
            ...
            <div class="about__wrapper-item_second">
                <div class="about__wrapper-item_second-container">
                    <p class="text-small about__wrapper-item_second-text">
                        Иногда ребятам сложно «продираться» сквозь форму
                        к смыслу слов и на это уходит много сил. Ребятам с
                        дислексией в текстовом облике слов часто чудится
                        какая-то абракадабра. Это особенность восприятия ими
                        визуального облика слов. В большинстве случаев интеллект
                        ребят в порядке, они хорошо решают примеры или
                        изъясняются устно.
                    </p>
                    <p class="text-small about__wrapper-item_second-text">
