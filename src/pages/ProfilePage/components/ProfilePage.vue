<template>
    <div class="profile__wrapper" v-if="!(userStore.children.length || groups.length)">
            ...
            <template #default="{ close }">
                <v-card prepend-icon="mdi-account" title="Введите данные ребёнка" class="window">
                    <v-card-text>
                        ...
                        <div class="form-input">
                            <label>Возраст</label>
                            <Input @blur="v$.age.$touch()" name="login" :class="{
                                'form-input': true,
                                red: isError.age,
                        ...
                        <div class="form-input">
                            <label>Класс</label>
                            <Input @blur="v$.grade.$touch()" name="login" :class="{
                                'form-input': true,
                                red: isError.grade,
    ...
    <div class="profile-child" v-if="userStore.currentUser.tasks_type === 'групповой'">
        <div class="profile-child__wrapper" v-for="(block, index) in groups" :key="index">
            <div class="delete-profile">
                <modalConfirm label="Удалить профиль">
                    <template #default="{ close }">
                        <div class="delete-profile__wrapper">
                ...
                <v-card prepend-icon="mdi-account" title="Введите данные группы" class="window">
                    <v-card-text>
                        ...
                        <div class="form-input">
                            ...
                            <Input @blur="V$.number_of_students.$touch()" name="login" :class="{
                                'form-input': true,
                        ...
                        <div class="form-input">
                            ...
                            <Input @blur="V$.average_age.$touch()" name="login" :class="{
                                'form-input': true,
        ...
        <img v-if="!groups.length" class="profile-child__img" src="@app/assets/img/Profile/Moa.svg" alt="" />
        <img v-if="groups.length" class="profile-child__img" src="@app/assets/img/Profile/lesyaProfileGroup.svg"
            alt="" />
    </div>
</template>
<script setup>
