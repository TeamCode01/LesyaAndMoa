            ...
            <div class="privacy-policy__container">
                ...
                <ol class="privacy-policy__info">
                    <li class="privacy-policy__info-title">
                        Общие положения
                        <p class="privacy-policy__info-subtitle">
                            ...
                            предпринимаемые Полежаева Анастасия
                    ...
                    <li class="privacy-policy__info-title">
                        ...
                        <ol class="privacy-policy__info-points">
                            ...
                            <li class="privacy-policy__info-subtitle">
                                Веб-сайт — совокупность графических
                            ...
                            <li class="privacy-policy__info-subtitle">
                                ...
                                с персональными данными неограниченного круга
                                лиц, в том числе обнародование персональных
                        ...
                        <ol class="privacy-policy__info-points">
                            <li class="privacy-policy__info-subtitle">
                                ...
                                <dl class="privacy-policy__info-sub-items">
                                    <dd
                                        class="privacy-policy__info-enumeration"
                                    >
                                        — получать от субъекта персональных
                                        данных достоверные информацию
                                        и/или документы, содержащие персональные
                                        данные;
                                    </dd>
                                    <dd
                                        class="privacy-policy__info-enumeration"
                                    >
                                        ...
                                        данных, Оператор вправе продолжить
                                        обработку персональных данных без
                                        согласия субъекта персональных данных
                                        при наличии оснований, указанных
                            ...
                            <li class="privacy-policy__info-subtitle">
                                ...
                                <dl class="privacy-policy__info-sub-items">
                                    ...
                                    >
                                        ...
                                        необходимую информацию в течение 10 дней
                                        с даты получения такого запроса;
                                        — публиковать или иным образом
                                        обеспечивать неограниченный доступ
                                        к настоящей Политике в отношении
                            ...
                            <li class="privacy-policy__info-subtitle">
                                ...
                                <dl class="privacy-policy__info-sub-items">
                                    ...
                                    >
                                        ...
                                        данных Оператором в доступной форме,
                                        и в них не должны содержаться
                                    ...
                                    >
                                        ...
                                        персональных данных, а также,
                                        на направление требования о прекращении
                                        обработки персональных данных;
                                    </dd>
                                    <dd
                                        class="privacy-policy__info-enumeration"
                    ...
                    <li class="privacy-policy__info-title">
                        ...
                        <ol class="privacy-policy__info-points">
                            ...
                            <li class="privacy-policy__info-subtitle">
                                ...
                                данных. Оператор принимает необходимые меры
                    ...
                    <li class="privacy-policy__info-title">
                        ...
                        <ul class="privacy-policy__info-points">
                            Цель обработки
                            <p>
                                &ensp;&bull;&ensp;предоставление доступа
                        ...
                        <ul class="privacy-policy__info-points">
                            Персональные данные
                            <p>&ensp;&bull;&ensp;электронный адрес</p>
                            <p>&ensp;&bull;&ensp;номера телефонов</p>
                            <p>&ensp;&bull;&ensp;фамилия и имя</p>
                            <p>
                                &ensp;&bull;&ensp;сведения об образовании,
                        ...
                        <ul class="privacy-policy__info-points">
                            Правовые основания
                            <p>
                                &ensp;&bull;&ensp;договоры, заключаемые между
                        ...
                        <ul class="privacy-policy__info-points">
                            ...
                            <p>
                                &ensp;&bull;&ensp;Сбор, запись, систематизация,
                    ...
                    <li class="privacy-policy__info-title">
                        ...
                        обработки персональных данных Безопасность персональных
                        данных, которые обрабатываются Оператором,
                        ...
                        <ol class="privacy-policy__info-points">
                            ...
                            <li class="privacy-policy__info-subtitle">
                                ...
                                почты на электронный адрес
                                Оператора nata418325@yandex.ru с пометкой «Отзыв
                            ...
                            <li class="privacy-policy__info-subtitle">
                                ...
                                и/или с указанными документами. Оператор
                                не несет ответственность за действия третьих
                                лиц, в том числе указанных в настоящем пункте
                                поставщиков услуг.
                            </li>
                            <li class="privacy-policy__info-subtitle">
                                ...
                                не действуют в случаях обработки персональных
                    ...
                    <li class="privacy-policy__info-title">
                        ...
                        <ol class="privacy-policy__info-points">
                            ...
                            <li class="privacy-policy__info-subtitle">
                                ...
                                по информационно-телекоммуникационным сетям или
                                без таковой.
                            </li>
                        </ol>
                    </li>
                    ...
                    <li class="privacy-policy__info-title">
                        Конфиденциальность персональных данных<br />Оператор
                        и иные лица, получившие доступ к персональным данным,
                    ...
                    <li class="privacy-policy__info-title">
                        ...
                        <ol class="privacy-policy__info-points">
                            <li class="privacy-policy__info-subtitle">
                                ...
                                его персональных данных, обратившись к Оператору
                                с помощью электронной
                                почты nata418325@yandex.ru.
                            </li>
                            <li class="privacy-policy__info-subtitle">
                            ...
                            <li class="privacy-policy__info-subtitle">
                                ...
                                по адресу https://леся-моа.рф/politika.
                            </li>
                        </ol>
                    </li>
                </ol>
